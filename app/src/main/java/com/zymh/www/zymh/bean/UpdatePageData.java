...
public class UpdatePageData implements Parcelable {
    public static final Creator<UpdatePageData> CREATOR = new Creator<UpdatePageData>() {
        @Override
        public UpdatePageData createFromParcel(Parcel source) {
            UpdatePageData var = new UpdatePageData();
        ...
        @Override
        public UpdatePageData[] newArray(int size) {
            return new UpdatePageData[size];
        }
    };
