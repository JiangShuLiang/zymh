...
public class ComicGroupDataBooks implements Parcelable {
    public static final Creator<ComicGroupDataBooks> CREATOR = new Creator<ComicGroupDataBooks>() {
        @Override
        public ComicGroupDataBooks createFromParcel(Parcel source) {
            ComicGroupDataBooks var = new ComicGroupDataBooks();
        ...
        @Override
        public ComicGroupDataBooks[] newArray(int size) {
            return new ComicGroupDataBooks[size];
        }
    };
